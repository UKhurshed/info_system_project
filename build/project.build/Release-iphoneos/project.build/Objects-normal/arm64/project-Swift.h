...
///
/// \param launchOptions options dictionary for application.
///
///
/// returns:
...
///
/// \param connectingSceneSession connectingSceneSession
///
/// \param options options
///
///
/// returns:
/// default instance of UISceneConfiguration
...
/// \param application application
///
/// \param sceneSessions sceneSessions
///
...
/// MainViewController
SWIFT_CLASS("_TtC7project18MainViewController")
...
@interface MainViewController (SWIFT_EXTENSION(project)) <UISearchBarDelegate>
...
@interface MainViewController (SWIFT_EXTENSION(project)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC7project17NewsTableViewCell")
@interface NewsTableViewCell : UITableViewCell
/// UIImageView for showing image each news item
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified newsImg;
/// UILabel for news description
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified newsDesc;
...
/// Use this method to optionally configure and attach the UIWindow <code>window</code> to the provided UIWindowScene <code>scene</code>.
/// \param scene UIScene
///
/// \param session UISceneSession
///
/// \param connectionOptions UIScene.ConnectionOptions
///
...
SWIFT_CLASS("_TtC7project20SourceViewController")
@interface SourceViewController : UIViewController
/// UILabel for showing selected category
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified chooseCategoryLabel;
/// override viewDidLoad
- (void)viewDidLoad;
/// Business button
/// \param sender button sender
///
- (IBAction)businessBtn:(id _Nonnull)sender;
/// Entertainment button
/// \param sender button sender
///
- (IBAction)enterBtn:(id _Nonnull)sender;
/// General button
/// \param sender button sender
///
- (IBAction)generalBtn:(id _Nonnull)sender;
/// Health button
/// \param sender button sender
///
- (IBAction)healthBtn:(id _Nonnull)sender;
/// Science button
/// \param sender button sender
///
- (IBAction)scienceBtn:(id _Nonnull)sender;
/// Sports button
/// \param sender button sender
///
- (IBAction)sportsBtn:(id _Nonnull)sender;
/// Technology button
/// \param sender button sender
///
- (IBAction)technologyBtn:(id _Nonnull)sender;
/// override viewWillDisappear
/// \param animated bool parametr for animated transition
///
- (void)viewWillDisappear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
